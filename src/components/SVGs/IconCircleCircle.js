...
const IconCircleCircle = ({ color, iconCSS }) => {
	return (
		<svg
			viewBox="0 0 100 100"
			css={css`
		...
		>
			...
			<path d="M50,97.5C23.8,97.5,2.5,76.2,2.5,50S23.8,2.5,50,2.5S97.5,23.8,97.5,50S76.2,97.5,50,97.5z M50,18.3    c-17.5,0-31.7,14.2-31.7,31.7S32.5,81.7,50,81.7S81.7,67.5,81.7,50S67.5,18.3,50,18.3z"></path>
		</svg>
	)
}

export default IconCircleCircle
