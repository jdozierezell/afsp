			...
			>
				<Form>
					...
					<p>
						...
						organizations. We hate spam as much as you do. We will
						use your email address to identify you should you
						request changes to your square later on.
					</p>
					<Field name="email" type="email" />
					<ErrorMessage name="email" />
					<label htmlFor="state">Your State</label>
					<p>
						Select the state where you live. If you live outside of
						the U.S., select 'Not Applicable' at the bottom of the
						list of choices. We will not share your information with
						any 3rd party.
					</p>
					<Field
						name="state"
					...
					<p>
						...
						uploading. They will appear as squares automatically.
					</p>
					<Field name="file" type="file" />
					<ErrorMessage name="file" /> */}
					<label htmlFor="description">Square Description</label>
					<p>
						Enter a brief description of your quilt square. This can
						be anything from a description of the person you have
						lost to a favorite moment or memory. If you like, you
						may leave this section blank. This field is not
						required.
					</p>
